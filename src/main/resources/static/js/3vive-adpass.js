...
(function (window) {
    ...
    function threeVive() {
        ...
        _threeViveObject.scrollTrigger = function () {
            ...
            if (window.scrollY > 200) {
                ...
                loginForm.innerHTML = "<label>username</label><br/>" +
                    ...
                    "<input type='button' value='Login' onsubmit='threeVive.getUser();'  style='" + btnStyles + "' />" +
        ...
        _threeViveObject.getUsers = function () {
            fetch('http://localhost:8080/api/v1/users').then(function (response) {
        ...
        _threeViveObject.getUser = function () {
            var tmpUsername = document.getElementById("adPassUserNameLog").value;

            alert(tmpUsername);
            fetch('http://localhost:8080/api/v1/users/' + tmpUsername).then(function (response) {
                return response.json();
            }).then(function (users) {
                console.log(users);
                _threeViveObject.users = users;
        ...
        _threeViveObject.createNewUser = function (userName, password, email) {
            ...
            fetch('http://localhost:8080/api/v1/users/register?partnerName=NYDN', {
                headers: {
        ...
        _threeViveObject.getPartnerNames = function (thisPartnerName) {
            fetch('http://localhost:8080/api/v1/users/register?partnerName=' + thisPartnerName).then(function (response) {
                return response.json();
        ...
        _threeViveObject.getUserInfo = function (userName) {
            fetch('http://localhost:8080/api/v1/users/' + username).then(function (response) {
                return response.json();
